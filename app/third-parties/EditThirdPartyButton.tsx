...
type EditThirdPartyButtonProps = {
  thirdParty: ThirdParty;
};

export default function EditThirdPartyButton({
  thirdParty,
}: EditThirdPartyButtonProps) {
  ...
  const handleOpen = () => {
    ...
    setWhatsapp(thirdParty.whatsapp || "");
    setError("");
    setOpen(true);
  };
          ...
          <div className="w-full max-w-md rounded-2xl bg-white shadow-2xl">
            ...
            <form onSubmit={handleSubmit}>
              <div className="space-y-5 px-6 py-6">
                ...
                <div>
                  <label
                    htmlFor={`edit-third-party-name-${thirdParty.id}`}
                  ...
                  <input
                    id={`edit-third-party-name-${thirdParty.id}`}
                    type="text"
                    value={name}
                    onChange={(e) =>
                ...
                <div>
                  <label
                    htmlFor={`edit-third-party-whatsapp-${thirdParty.id}`}
                    className="mb-2 block text-xs font-medium text-black/60"
                  >
                    WhatsApp Number
                  ...
                  <input
                    id={`edit-third-party-whatsapp-${thirdParty.id}`}
                    type="tel"
                    value={whatsapp}
                    onChange={(e) =>
